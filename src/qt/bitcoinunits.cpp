...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CST");
    case mBTC: return QString("mCST");
    case uBTC: return QString::fromUtf8("μCST");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Capstones"));
    case mBTC: return QString(QObject::tr("Milli-Capstones (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Capstones (1 / 1,000,000)"));
    default: return QString("???");
    }
}
