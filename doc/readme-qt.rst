Capstone-qt: Qt4 GUI for Capstone
===============================
...
Alternatively, install Qt Creator and open the `Capstone-qt.pro` file.

An executable named `Capstone-qt` will be built.
...
A warning for people using the *static binary* version of Capstone on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Capstone is linked against libdb5.3.
...
installed causes Capstone-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
